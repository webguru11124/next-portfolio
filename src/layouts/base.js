...
const BaseLayout = ({ children }) => {
  return (
    <div id="main">
      <Head>
        <title>Lucas Eriksson | Web & Mobile developer</title>
        ...
        <meta property="og:site_name" content="Lucas Eriksson | Web & Mobile developer" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Lucas Eriksson | Web & Mobile developer" />
